        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">뉴스 제목</label>
                <Input
                  onChange={handleMetadataChange}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">뉴스 설명</label>
                <Input
                  onChange={handleMetadataChange}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                다양한 이미지 URL을 지원하여 시각적으로 풍부한 뉴스를 만들 수 있습니다
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                몇 초 만에 완성도 높은 뉴스 페이지를 생성할 수 있습니다
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                소셜 미디어와 검색 엔진에 최적화된 메타데이터를 자동으로 생성합니다
              </p>
            </div>
          </div>
        </div>
